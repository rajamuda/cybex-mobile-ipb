<?php
  ...
  $sql = "SELECT id_artikel, id_kategori, id_topik, id_komoditas, judul_artikel, tanggal, nama_user_input, total_baca, total_komentar FROM artikel_view WHERE id_kategori=1 AND is_remove='N' ORDER BY id_artikel DESC";
